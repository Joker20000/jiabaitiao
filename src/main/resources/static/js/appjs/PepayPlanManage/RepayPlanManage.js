        ...
        .bootstrapTable(
            {
               ...
               queryParams : function(params) {
                    return {
                        ...
                        overdueState : $('#overdueState').val(),
                        latestTimeStart : $('#latestTimeStart').val(),
                        latestTimeEnd : $('#latestTimeEnd').val(),
                        mobile : $('#mobile').val(),
                        fullRepaymentTimeStart : $('#fullRepaymentTimeStart').val(),
                        fullRepaymentTimeEnd : $('#fullRepaymentTimeEnd').val()
                    };
                },
...
function repayplanlist(repayPlanNo) {
    layer.open({
        ...
        area : [ '800px', '520px' ],
        content : prefix + '/repayplanlist?repayPlanNo='+repayPlanNo // iframe的url
    });
}
//逾期费用
function overdue(repayPlanNo) {
    layer.open({
        ...
        shadeClose : false, // 点击遮罩关闭层
        area : [ '800px', '520px' ],
        content : prefix + '/overdue?repayPlanNo='+repayPlanNo // iframe的url
    });
}
// 下载
