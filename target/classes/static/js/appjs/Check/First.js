        ...
        .bootstrapTable(
            {
                ...
                queryParams : function(params) {
                    return {
                        ...
                        chackState :getchackState($('#chackState').val()),
                    ...
                    },*/
                    {
                        ...
                        formatter : function(value, row) {
                            var e = '<a  class="btn btn-primary btn-sm" href="#" mce_href="#" title="编辑" ' +
                                'onclick="add(\''+row.chackNo+'\',\''+row.accountNo+'\',\''+row.userId+'\')"><i class="fa fa-edit "></i></a> ';
                            return e;
                        }
                    } ],
                fixedColumns: true,
...
function edit(eid) {
    layer.open({
        ...
        shadeClose : false,
        area : [ '800px', '520px' ],
        content : '/sys/user/edit/' + eid // iframe的url
    });
}
function add(chackno,accountNo,userId) {
    ...
    layer.open({
        ...
        shadeClose: false,
        area: ['800px', '520px'],
        content: '/ch/ec/personal/' + chackno +"/"+ accountNo +"/"+ pass+"/"+userId
    });
}
function read(id) {
    layer.open({
